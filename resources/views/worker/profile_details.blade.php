                    ...
                    <div class="card-body p-4">
                        <div class="d-md-flex align-items-center">
                            <div class="profile-img-container mb-3 mb-md-0">
                                <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=300&q=80" alt="Profile Image" class="profile-img shadow">
                                <span class="badge-status online"></span>
                            </div>
                            <div class="ms-md-4">
                                <h2 class="fw-bold mb-1">Ahmed Khan <i class="fas fa-check-circle text-primary fs-5"></i></h2>
                                <p class="text-muted mb-2"><i class="fas fa-tools me-2"></i>Master Electrician & Wiring Expert</p>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="rating-pill">
                                        <i class="fas fa-star text-warning"></i> 4.9 <span class="text-muted">(128 Reviews)</span>
                                    </div>
                ...
                <div class="card profile-sub-card mb-4">
                    <div class="card-body p-4">
                        ...
                        <p class="text-secondary leading-relaxed">
                            Professional electrician with over 8 years of experience in residential and commercial wiring. 
                            Specializing in UPS installations, short circuit repairs, and smart home automation. 
                            I pride myself on punctuality, safety standards, and providing long-term solutions for my clients.
                        </p>
                    </div>
                </div>
                ...
                <div class="card profile-sub-card">
                    <div class="card-body p-4">
                        ...
                        <div class="review-item mb-3 pb-3 border-bottom">
                            ...
                            <p class="small text-muted mb-0">"Excellent service! Fixed my main board issue within 30 minutes. Highly recommended for electrical work."</p>
                        </div>
                    </div>
                </div>
            </div>
