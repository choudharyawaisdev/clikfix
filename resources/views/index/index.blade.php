        ...
        <div class="container text-center">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <a href="#section-{{ Str::slug($name) }}" class="text-decoration-none text-dark">
                        <div class="cat-box">
                ...
                @if($filteredWorkers->count() > 0)
                    <div class="category-row mb-5" id="section-{{ Str::slug($serviceName) }}">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="#" class="btn btn-outline-warning btn-sm rounded-pill px-3">View All {{ $serviceName }}s</a>
                        </div>
